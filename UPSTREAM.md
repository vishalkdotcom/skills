...
Listed in [`.upstream-exclude`](./.upstream-exclude): removed skills, `obsidian-vault`, `git-guardrails-claude-code`, `scaffold-exercises`, `edit-article`, in-progress skills except `teach` and `loop-me`, etc.
